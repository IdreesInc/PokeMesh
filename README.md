...
*This program uses a VLM (Vision Language Model) to process the game screenshots, but like all of my open-source projects, PokeMesh was made by hand and not "vibe coded" with AI. While you are welcome to use whatever tools you prefer to contribute, please be sure to review all code by hand and do not blindly commit.*